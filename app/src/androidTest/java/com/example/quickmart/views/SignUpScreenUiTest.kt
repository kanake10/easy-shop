...
class SignUpScreenUiTest {
    ...
    fun test_EasyShopWelcomeTitle_isDisplayed() {
        ...
        composeTestRule.onNodeWithText("Welcome to EasyShop").assertExists()
    }

    @Test
    fun testNameField_isInputtedCorrectly() {
        ...
        composeTestRule.onNodeWithText("Name").performTextInput("Ezra")
        assert(name.text == "Ezra")
    }
    ...
    @Test
    fun testConfirmPasswordField_isInputtedCorrectly() {
        var confirmPassword = TextFieldValue("")
        ...
        composeTestRule.setContent {
            EasyShopPasswordField(
                ...
                isError = confirmPassword.text.isBlank() || confirmPassword.text != password
            )
        }
        ...
        assert(confirmPassword.text == "password123")
    }

    @Test
    fun testSignUpButton_isClickable() {
        var clicked = false
        composeTestRule.setContent {
